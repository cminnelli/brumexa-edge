...
function measureNoiseFloor({ device = 'plughw:0,0', durationMs = 4000, gain = 1.0 } = {}) {
  return new Promise((resolve, reject) => {
    ...
    const finish = (err) => {
      ...
      resolve({ noiseFloorDbfs, worstPeak, ticks, durationMs });
    };
...
module.exports = { measureNoiseFloor };
