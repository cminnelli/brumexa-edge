...
// Subido de 8000 a 12000: el arranque del agente (VAD + config del negocio,
// sin cache del lado de brumexa-livekit-agent) a veces se pasaba de los 8s
// y disparaba reintentos de más. Ajustable acá directo, sin pasar por .env.
const AGENT_DETECT_TIMEOUT_MS = parseInt(process.env.AGENT_DETECT_TIMEOUT_MS || '12000', 10);
