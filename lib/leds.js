...
function previewBreathe(h, s) {
  ...
  _startPulse({
    periodMs: 1900, floor: IDLE_FLOOR,
...
// Entrada ("empezaste a hablar"): LED 0 primero, LED 7 al final.
...
// al final, como si la ola retrocediera por donde vino. Apuntado a ~1s en
// total (staggerMs*7 + riseMs) en vez de los ~1.1s del fundido parejo
// anterior — la idea es que se sienta rápido y liviano, no una despedida
// larga.
const SPEECH_OFFSET_STAGGER_MS = 35;
const SPEECH_OFFSET_RISE_MS    = 720;
