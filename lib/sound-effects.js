...
function buildLivekitChimePcm(gain = 1, expectedFormat = null) {
...
module.exports = { playSound, playWifiConnectedSound, playWifiDisconnectedSound, buildLivekitChimePcm, setSoundsEnabled, getSoundsEnabled };
