 ...
 *
 * Pensado para eventos puntuales de WiFi (AP de aprovisionamiento activado,
 * o conexión exitosa a la red real), no para audio continuo. Si aplay falla
 * o no hay speaker conectado, no debe tirar abajo el proceso — solo loguear.
 */
...
module.exports = { playSound, playWifiConnectedSound };
